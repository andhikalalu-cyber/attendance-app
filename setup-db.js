...
async function setupDatabase() {
  try {
    ...
    console.log('✓ Checking if app_data table exists...');
    ...
    if (tableError && (tableError.code === '42P01' || tableError.message?.includes('does not exist'))) {
      ...
      console.log('⚠️  Table does not exist. Please run this SQL in Supabase console:');
      console.log('\n' + '='.repeat(60));
      console.log(`
...
CREATE INDEX IF NOT EXISTS idx_app_data_updated_at ON app_data(updated_at DESC);
    ...
    if (fetchError) {
      console.log('⚠️  Fetch test error:', fetchError.message);
    } else {
    ...
    console.log('\n✨ Setup complete! Aplikasi siap digunakan.');
    console.log('\n🌐 Test aplikasi di:');
